...
import { AddCompanyComponent } from "./component/company/AddCompanyComponent";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/clientlist/editclient/:clientId"
          element={<EditClient />}
        />
        ...
        <Route
          path="/employeelist/editemployee/:employeeId"
        ...
        {/* Add Company */}
        <Route path="/add-company" element={<AddCompanyComponent />} />
