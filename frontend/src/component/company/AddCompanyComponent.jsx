...
import {
  ...
  useGetCompanies,
  useDeleteCompany,
} from "../../services/virtualServices";
import { notifyDone, notifyErorr } from "../../assets/toster";

export const AddCompanyComponent = () => {
  const validation = {
    name: {
      required: {
        value: true,
  ...
  var { data, isError, isLoading, refetch } = useGetCompanies();
                                  ...
                                  >
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        ...
                                        company? <br />
                                        If you created models of this company
                                        then it will not deletable.
                                      </div>
